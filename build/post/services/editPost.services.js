...
const editPostService = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    // const query = { _id: id}
    try {
        return yield post_models_1.PostModel.findByIdAndUpdate(id, data, { returnDocument: 'after' });
    }
    catch (error) {
