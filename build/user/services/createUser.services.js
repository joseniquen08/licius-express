...
const createUserService = (userRequest) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        userRequest.password = yield (0, encrypt_utils_1.encryptText)(userRequest.password);
        const user = yield (0, createAny_1.createAny)(user_models_1.UserModel)(userRequest);
        return user;
    }
    catch (error) {
