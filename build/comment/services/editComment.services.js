...
const editCommentService = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    // const query = { _id: id }
    try {
        return yield comment_models_1.CommentModel.findByIdAndUpdate(id, data, { returnDocument: 'after' });
    }
    catch (err) {
